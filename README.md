...
You can dump the strings to the console and also forward them to the BoatBeaconApp.com server to display on a live map view and in our free <a href="http://boatwatchapp.com">Boat Watch app</a>, available for iPhone,iPad,Mac and Android.
